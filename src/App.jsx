...
//       {/* Secondary nav bar with mixed in-page scroll and page navigation */}
...
//               {/* For page anchors with scroll */}
//               <a href="#services" className="nav-link" onClick={(e) => { e.preventDefault(); smoothScrollTo('#services'); }}>Services</a>
//               <a href="#features" className="nav-link" onClick={(e) => { e.preventDefault(); smoothScrollTo('#features'); }}>Features</a>
              
//               {/* For full page navigation use React Router Link */}
...
// Custom hook to scroll to top or to anchors on route changes
...
function App() {
  ...
  // Smooth scroll helper for in-page anchors (onClick)
  const smoothScrollTo = (target) => {
    const element = document.querySelector(target);
    if (element) {
      const headerOffset = 80;
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      const navbar = document.querySelector('.navbar');
      if (navbar) {
        navbar.style.background = window.scrollY > 100 ? 'rgba(var(--color-slate-900-rgb), 0.98)' : 'rgba(var(--color-slate-900-rgb), 0.95)';
      }
    };

    // Navbar resize behavior cleanup
    const handleResize = () => {
  ...
  return (
    <>
      <Router>
        <ScrollToTopOrAnchor />
        {/* Primary nav for route navigation */}
        ...
        <Routes>
              ...
              <div className="App" ref={appRef}>
                  ...
                  <div className="container">
                    <div className="nav-content">
                      ...
                      <div className="nav-links">
                        ...
                        <Link to="/about" className="nav-link">About</Link>
                        <Link to="/contact" className="nav-link">Contact</Link>
                        <button className="btn btn--primary" onClick={openModal}>Get Quote</button>
                        <button className="btn btn--primary" onClick={() => alert('Login modal placeholder')}>Login</button>
                      </div>
                      <button
                        className="mobile-menu-btn"
                        id="mobileMenuBtn"
                  ...
                  <div className="container">
                    <div className="hero-content">
                      <div className="hero-text">
                        ...
                        <p className="hero-subtitle">Supreme Quality texture coatings with 10-year warranty. Transform your spaces with European imported materials and professional installation.</p>
                        <div className="hero-actions">
                          <button className="btn btn--primary btn--lg" onClick={openModal}>Get Free Quote</button>
                          <button className="btn btn--outline btn--lg" onClick={() => smoothScrollTo('#services')}>View Services</button>
                        </div>
                        <div className="hero-features">
                          <div className="hero-feature"><span className="feature-icon">✓</span><span>10-Year Warranty</span></div>
                          <div className="hero-feature"><span className="feature-icon">✓</span><span>European Imports</span></div>
                          <div className="hero-feature"><span className="feature-icon">✓</span><span>Professional Installation</span></div>
                        </div>
                      </div>
                      <div className="hero-visual">
                        <div className="texture-showcase">
                ...
                <section className="services" id="services">
                  <div className="container">
                    ...
                    <div className="services-grid">
                      {/* Repeat service cards as per your design */}
                      <div className="service-card">
                        <div className="service-icon">🏛️</div>
                        <h3 className="service-title">Quartz Plaster</h3>
                        <p className="service-description">Seamless look with tough nature, stone and glass combination for vibrant walls and floors</p>
          ...
          {/* Other pages routed to show respective components with spacing */}
        ...
        {notification && (
          <div className={`notification notification--${notification.type}`} style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <button onClick={removeNotification} style={{ background: 'none', border: 'none', color: 'inherit', cursor: 'pointer', padding: '4px', marginLeft: '12px' }}>&times;</button>
            </div>
          </div>
        )}
      </Router>
